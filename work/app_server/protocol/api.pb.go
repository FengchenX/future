...
type ReqSetAccount struct {
	...
	UserAccount *UserAccount `protobuf:"bytes,4,opt,name=UserAccount" json:"UserAccount,omitempty"`
}
...
type ReqResetQuo struct {
	...
	SubCode string `protobuf:"bytes,3,opt,name=SubCode" json:"SubCode,omitempty"`
}
