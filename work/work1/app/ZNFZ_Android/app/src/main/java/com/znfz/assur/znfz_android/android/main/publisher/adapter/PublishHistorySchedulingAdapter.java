 ...
 */
public class PublishHistorySchedulingAdapter extends RecyclerView.Adapter<PublishHistorySchedulingAdapter.ViewHolder> {

    private final Context mContext;
    private List<String> listItems;


    public PublishHistorySchedulingAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        // 设置视图数据
        holder.mTVSchedulingCompany.setText(listItems.get(position));
